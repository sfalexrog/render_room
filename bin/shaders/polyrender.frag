...
layout(location = 4) uniform float LightPower;
...
void main()
{
	...
	vec3 MaterialSpecularColor = vec3(0.3,0.3,0.0);
...
//		MaterialAmbientColor +
		...
		MaterialSpecularColor * LightColor * LightPower * pow(cosAlpha,8) / (distance*distance)
        , 1.0f);
}